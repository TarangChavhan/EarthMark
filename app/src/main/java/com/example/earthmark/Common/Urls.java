...
public class Urls {
    public static String webServiceAddress = "http://192.168.240.13:80/EarthMark/";
    ...
    public static String getAllCategoryImages ="http://192.168.240.13:80/EarthMark/images/";
    ...
    public static String ShowAllLands = webServiceAddress+"ShowAllLands.php";
